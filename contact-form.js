(function () {
  ...
  function injectLayoutStyles() {
    ...
    style.textContent =
      ...
      '#rec542077162 .t698,#rec542077162 form,#rec542077162 .t-form__submit{pointer-events:auto;}' +
      '#rec542541917 .t698,#rec542541917 form,#rec542541917 .t-form__submit{pointer-events:auto;}';
  ...
  async function sendToMailApi(data) {
    var response = await fetch(endpoint, {
      ...
      body: JSON.stringify({
        ...
        source: window.location.hostname || 'jarmusch.am',
